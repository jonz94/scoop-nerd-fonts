...
if (originInstallerScript.length !== 41) {
...
const loopThroughFilesFirstStep = originInstallerScript.at(
  indexOfMainInstallerFirstStep + 36
);
...
const originUninstallMessage = originUninstallerScript.at(-2);

if (!originUninstallMessage.startsWith("    Write-Host")) {
  console.log(filename);
}

if (originUninstallerScript.length !== 10) {
